...
%This makes \inla a desired approach when working when adjusting models to data, as opens up for a trial-and-error approach to model fitting with a more realistically available time scope. 

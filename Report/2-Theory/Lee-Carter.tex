...
For the hyperparameters $\tau_\kappa, \tau_\alpha, \tau_\gamma, \tau_\beta, \tau_\epsilon$ we assign a type of prior called Penalized complexity (PC) priors, which was proposed by \textcite{SimpsonRueRiebler2017} to by well-suited for these types of models \parencite{Rubio2020}. \textcolor{myDarkGreen}{Note: this is a bit inaccurate (it is only well-suited to the random walks), you should elaborate. }

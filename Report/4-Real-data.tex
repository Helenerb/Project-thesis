...
\begin{table}
    \begin{center}
        ...
        \end{tabular}
    \caption{Stomach cancer data, results from sensitivity analysis}\label{tbl:mv-sensitivity-stomach}
    \end{center}
\end{table}

Age <= 5 omitted
 Lung cancer data - senstivity analysis: # A tibble: 3 x 4
  prior                      MSE   MDSS contained
  <chr>                    <dbl>  <dbl>     <dbl>
1 P(sd > 1) = 0.05 0.00000001238 -19.83    0.9028
2 P(sd > 1) = 0.95 0.00000001189 -19.74    0.9028
3 P(sd > 3) = 0.05 0.00000001182 -19.73    0.9028

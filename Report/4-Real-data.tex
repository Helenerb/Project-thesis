...
Note!!! Stomach cancer only?? 
We note that it seems like what age we set as the cut-off when calculating the MDSS influence which of the APC1 and APC2 models get the lowest MDSS. If we omit more ages, e.g. all predictions where $x < 7$, when calculating the MDSS, the APC1 model get a lower score than the APC2 model. We interpret this as an indication that the APC1 model is better suited to model mortality rates for older age groups.  } 
...
\begin{centering}
    \begin{table}[h!]
        ...
        \end{tabular}
        \caption{Stomach cancer data, cutoff at x <= 5}
    \end{table}
\end{centering}
...
\begin{centering}
    \begin{table}[h!]
        ...
        Model & MSE &   MDSS & Contained 95\%-interval\\
        \hline
        APC1    & 4.672e-9 & -18.59    & 0.8444 \\
        APC2    & 2.606e-9 & -19.01    & 0.9556 \\
        LC         & 6.173e-8 & -13.98    & 0.5444 \\
        LCC        & 5.695e-9 & -18.93    & 0.9889 \\
        LCC-linear & 6.285e-9 & -18.79    & 0.9667 \\
        \end{tabular}
        \caption{Lung cancer data, cutoff at x <= 7}
    \end{table}
\end{centering}
...
\begin{centering}
    \begin{table}[h!]
        ...
        Model & MSE &   MDSS & Contained 95\%-interval\\
        \hline
        APC1    & 2.357e-9 & -18.61    & 0.8778 \\
        APC2    & 7.004e-9 & -18.74    & 0.9778 \\
        LC         & 8.221e-8 & -13.62    & 0.5333 \\
        LCC        & 1.334e-8 & -18.38    & 0.9333 \\
        LCC-linear & 1.369e-8 & -18.29    & 0.8778 \\
        \end{tabular}
        \caption{Stomach cancer data, cutoff at x <= 7}
    \end{table}
\end{centering}

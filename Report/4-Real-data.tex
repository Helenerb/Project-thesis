...
We begin by fitting the Lee-Carter models to the full data sets to investigate if the results obtained from the previous sections are applicable to real-life situations. We use the same inference procedure as described in Section \ref{sec:implementationInlabru} and the script used to produce the results can be found at \texttt{real-data/real-data-univariate/uv-fit-full-data.R}. 
